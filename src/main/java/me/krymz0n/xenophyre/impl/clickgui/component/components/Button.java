package me.krymz0n.xenophyre.impl.clickgui.component.components;
...
import me.krymz0n.xenophyre.impl.clickgui.component.components.sub.Checkbox;
import me.krymz0n.xenophyre.impl.clickgui.component.components.sub.Keybind;
import me.krymz0n.xenophyre.impl.clickgui.component.components.sub.ModeButton;
import me.krymz0n.xenophyre.impl.clickgui.component.components.sub.Slider;
import me.krymz0n.xenophyre.impl.clickgui.component.components.sub.VisibleButton;
...
public class Button extends Component {
	...
	public Button(Module mod, Frame parent, int offset) {
		...
		height = 12;
		int opY = offset + 12;
		if(Main.settingManager.getSettingsByMod(mod) != null) {
			for(Setting s : Main.settingManager.getSettingsByMod(mod)){
				if(s.isCombo()){
	...
	public void renderComponent() {
		...
		Minecraft.getMinecraft().fontRenderer.drawStringWithShadow(this.mod.getName(), (parent.getX() + 2) * 2, (parent.getY() + offset + 2) * 2 + 4, this.mod.isToggled() ? 0x999999 : -1);
		...
		if(this.open) {
			if(!this.subcomponents.isEmpty()) {
				...
				Gui.drawRect(parent.getX() + 2, parent.getY() + this.offset + 12, parent.getX() + 3, parent.getY() + this.offset + ((this.subcomponents.size() + 1) * 12), 0x000000);
			}
		}
	}
